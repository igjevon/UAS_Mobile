...
public class ProductDetailsDressesActivity extends AppCompatActivity {
    Button addToCart;
    ...
    ImageView xurl_product_image1,
            ...
            xurl_product_image4, xurl_product_image5, xurl_product_image6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (reference != null){
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        if (dataSnapshot.hasChild("nama_barang")) {
                            ...
                            Toast.makeText(ProductDetailsDressesActivity.this, "Data do not exists...", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(ProductDetailsDressesActivity.this, "Does not exists..........", Toast.LENGTH_SHORT).show();
                    }
                }
            ...
            Toast.makeText(ProductDetailsDressesActivity.this, "No data found...", Toast.LENGTH_SHORT).show();
        }
