...
public class CheckoutBottomsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checkout_bottoms);
            ...
            public void onClick(View v) {
                ...
                reference3.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Intent gotopayment = new Intent(CheckoutBottomsActivity.this, PaymentActivity.class);
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotoback = new Intent(CheckoutBottomsActivity.this, HomeActivity.class);
